...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null && isPraperSave()) {
    ...
    public boolean isPraperSave() {
        return praperSave;
    }

    public void setPraperSave(boolean praperSave) {
        this.praperSave = praperSave;
    }
    ...
    private String getFilePath() {
        ...
        if (isSDCardExist && isRootDirExist) {
            file_dir = Environment.getExternalStorageDirectory().getPath() + "/topactivity/";
        } else {
    ...
    private String saveCatchInfo2File(Throwable ex) {
        ...
        try {
            ...
            String fileName = "RaoQianNeeds_" + time + "_" + timestamp + ".txt";
